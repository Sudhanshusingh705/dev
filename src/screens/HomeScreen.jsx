...
//   LatestNotification,
//   Newsletter,
// } from '../pages'; // Consolidate imports if possible
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mainContainer}>
          ...
          >
            ...
            <Divider title="Top Universities" component={TopUniversities} />
            <Divider />
...
// Section Component for Dynamic Rendering
...
// Divider Component for Spacing
const Divider = ({ title, component }) => (
  <>
    {title && <Section title={title} component={component} />}
    <View style={styles.sectionDivider} />
  </>
);
